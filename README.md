...
class Henri:
    def __init__(self):
        self.area_de_estudo = "Ciência de Dados & Machine Learning"
        self.estudo_dados   = ["Python", "Pandas", "NumPy", "scikit-learn", "Plotly", "Streamlit"]
        self.metodo         = "construo produtos reais com IA (Claude Code & cia.) 🤖"
        # ferramentas que uso pra ENTREGAR projetos — a IA escreve boa parte do código (não é domínio profissional):
        self.ferramentas    = ["Next.js", "React", "TypeScript", "Supabase", "Cloudflare", "Tailwind"]
        self.foco           = ["IA & LLMs", "Dados", "Automação", "SaaS"]
        self.aprendendo     = "um pouco mais, todo dia 🚀"

    def entregar(self, ideia):
        # eu trago a ideia e a direção; a IA acelera o código
        return "produto no ar"
```

> Estudo Ciência de Dados & ML e **construo produtos reais com IA** — uso assistentes como o Claude Code como par de programação pra transformar ideias em apps que funcionam, da ideia ao deploy. 🤖⚡

<br/>

<!-- ====================== STACK ====================== -->
## 🛠️ Tecnologias & Ferramentas — estudo Dados & ML, e entrego o resto com IA
...
<img height="172em" src="https://github-readme-stats-sigma-five.vercel.app/api?username=HenriMafra&show_icons=true&include_all_commits=true&count_private=true&theme=tokyonight&hide_border=true&rank_icon=percentile&title_color=7aa2f7&icon_color=bb9af7" />
<img height="172em" src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=HenriMafra&layout=compact&langs_count=8&theme=tokyonight&hide_border=true&title_color=7aa2f7" />

<br/>

<img src="https://streak-stats.demolab.com?user=HenriMafra&theme=tokyonight&hide_border=true&ring=7aa2f7&fire=bb9af7&currStreakLabel=7aa2f7" />
...
## 👾 Minhas contribuições (modo Pac-Man)
...
## 🎮 Mini-game: Neon Snake

Cansou de só ler estatística? **Joga um Snake** que eu construí com IA — roda 100% no navegador, com placar, recorde salvo e controle por toque no celular. 🐍

<a href="https://henrimafra.github.io/game/">
  <img src="https://img.shields.io/badge/%E2%96%B6_JOGAR_AGORA-9ECE6A?style=for-the-badge&logo=gamejolt&logoColor=000000&labelColor=7dcfff" height="46" />
</a>

<sub>🎯 Setas / WASD para mover • Espaço para pausar • arraste a tela no celular</sub>
...
⭐️ De [HenriMafra](https://github.com/HenriMafra) — *"a melhor forma de prever o futuro é construí-lo."*
